<article <?php post_class(); ?>><!--Adionar class para os tipo de posts normal-->
     <h2><?php the_title(); ?></h2> <!--Chamada do titulos dos posts -->
       <!--Chamada da miniatura de imagens para posts os arguntos array são para personalizar o tamanho da imagem-->
        ...
        <div class="meta-info">
          <p>Published in <?php echo get_the_date(); ?>  by <?php the_author_posts_link(); ?> </p> <!--Data dos posts é as categorias -->
