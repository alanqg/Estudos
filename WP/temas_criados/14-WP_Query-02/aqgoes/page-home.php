                    ...
                    <!--Chamando os psots da página  home-->
                        <div class="row">
                            <?php
                                ...
                                $destaque = new WP_Query('type_post&posts_per_page=1&cat=9,7'); //Será guardado a categoeria ou remrover para os psots destaque
                        ...
                        <!--Segunda estrura de posts para a home-->
                        <?php
                            $args = array(
                                'type' => 'post',
                                'posts_per_page' => 2,
                                //Categoaria que não irá aparecer
                                'category__not_in' => array(7),
                                //o que Que aparece
                                'category__in' => array(8,25),    
                                //Não repetir posts dos dois que serão para mostrado 
                                'offset' => 1, 
                            );

                             //Variavel para chamando o post destaque
                             $secundaria = new WP_Query($args); //Será guardado a categoeria ou remrover para os psots destaque
                                //Desntro da variável destaque tem o conteúdo das categoerias tecnologia é esportes
                                //Chamando o loop WP com o objeto que no caso é a variável destaque
